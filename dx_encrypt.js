/*function jiami(n) {
    ...
    var u = /\+/g,
        t = n.cookie = function (u, o, s) {
            ...
            typeof s.expires == 'number' && (y = s.expires, a = s.expires = new Date, a.setTime( + a + y * 86400000)),
                document.cookie = [
                    i(u),
                    '=',
                    e(o),
...
}(this, document, jQuery); */var CryptoJS = CryptoJS || function (n, t) {
        var u = {
            },
            f = u.lib = {
            },
            ...
            r = f.WordArray = i.extend({
                ...
                random: function (t) {
                    for (var i = [
                    ], u = 0; u < t; u += 4) i.push(4294967296 * n.random() | 0);
            ...
            l = e.Hex = {
                stringify: function (n) {
                    var u = n.words,
                        ...
                        r;
                    for (n = n.sigBytes, i = [
                    ], t = 0; t < n; t++) r = u[t >>> 2] >>> 24 - 8 * (t % 4) & 255,
                        i.push((r >>> 4).toString(16)),
                        i.push((r & 15).toString(16));
                    return i.join('')
                },
                parse: function (n) {
                    for (var i = n.length, u = [
                    ], t = 0; t < i; t += 2) u[t >>> 3] |= parseInt(n.substr(t, 2), 16) << 24 - 4 * (t % 8);
            ...
            s = e.Latin1 = {
                stringify: function (n) {
                    var r = n.words,
                        ...
                        t;
                    for (n = n.sigBytes, i = [
                    ], t = 0; t < n; t++) i.push(String.fromCharCode(r[t >>> 2] >>> 24 - 8 * (t % 4) & 255));
                    return i.join('')
                },
                parse: function (n) {
                    for (var i = n.length, u = [
                    ], t = 0; t < i; t++) u[t >>> 2] |= (n.charCodeAt(t) & 255) << 24 - 8 * (t % 4);
    ...
    n.enc.Base64 = {
        stringify: function (n) {
            var i = n.words,
                ...
                r;
            for (n.clamp(), n = [
            ], t = 0; t < u; t += 3) for (e = (i[t >>> 2] >>> 24 - 8 * (t % 4) & 255) << 16 | (i[t + 1 >>> 2] >>> 24 - 8 * ((t + 1) % 4) & 255) << 8 | i[t + 2 >>> 2] >>> 24 - 8 * ((t + 2) % 4) & 255, r = 0; 4 > r && t + 0.75 * r < u; r++) n.push(f.charAt(e >>> 6 * (3 - r) & 63));
        ...
        parse: function (n) {
            ...
            for (var i = [
            ], u = 0, r = 0; r < e; r++) r % 4 && (o = f.indexOf(n.charAt(r - 1)) << 2 * (r % 4), s = f.indexOf(n.charAt(r)) >>> 6 - 2 * (r % 4), i[u >>> 2] |= (o | s) << 24 - 8 * (u % 4), u++);
            return t.create(i, u)
        },
    ...
    for (var o = CryptoJS, e = o.lib, c = e.WordArray, s = e.Hasher, e = o.algo, t = [
    ], h = 0; 64 > h; h++) t[h] = 4294967296 * n.abs(n.sin(h + 1)) | 0;
    e = e.MD5 = s.extend({
        _doReset: function () {
    ...
    r = (i.pad = {
        ...
        pad: function (n, t) {
            for (var i = 4 * t, i = i - n.sigBytes % i, f = i << 24 | i << 16 | i << 8 | i, r = [
            ], u = 0; u < i; u += 4) r.push(f);
            i = e.create(r, i);
            n.concat(i)
        },
        unpad: function (n) {
    ...
    var h = t.CipherParams = f.extend({
        ...
        s = (i.format = {
            ...
            stringify: function (n) {
                var t = n.ciphertext;
                return n = n.salt,
                    (n ? e.create([1398893684,
                        1701076831]).concat(n).concat(t)  : t).toString(l)
            },
            parse: function (n) {
                var t,
                    i;
    ...
    for (var i, tt, s = CryptoJS, y = s.lib.BlockCipher, h = s.algo, t = [
    ], p = [
    ], w = [
    ], b = [
    ], k = [
    ...
    ], f = 0; 256 > f; f++) u[f] = 128 > f ? f << 1 : f << 1 ^ 283;
    ...
    h = h.AES = y.extend({
        _doReset: function () {
            for (var n, f = this._key, e = f.words, r = f.sigBytes / 4, f = 4 * ((this._nRounds = r + 6) + 1), u = this._keySchedule = [
            ], i = 0; i < f; i++) i < r ? u[i] = e[i] : (n = u[i - 1], i % r ? 6 < r && 4 == i % r && (n = t[n >>> 24] << 24 | t[n >>> 16 & 255] << 16 | t[n >>> 8 & 255] << 8 | t[n & 255])  : (n = n << 8 | n >>> 24, n = t[n >>> 24] << 24 | t[n >>> 16 & 255] << 16 | t[n >>> 8 & 255] << 8 | t[n & 255], n ^= tt[i / r | 0] << 24), u[i] = u[i - r] ^ n);
        ...
        _doCryptBlock: function (n, t, i, r, u, f, e, o) {
            for (var b = this._nRounds, h = n[t] ^ i[0], c = n[t + 1] ^ i[1], l = n[t + 2] ^ i[2], s = n[t + 3] ^ i[3], a = 4, w = 1; w < b; w++) var v = r[h >>> 24] ^ u[c >>> 16 & 255] ^ f[l >>> 8 & 255] ^ e[s & 255] ^ i[a++],
...
};*/ function setCursorPosition(n) {
    return this.lengh == 0 ? this : $(this).setSelection(n, n)
};function setSelection(n, t) {
...
};function valAesEncrypt() {
    return aesEncrypt(this.val())
};function valAesDecrypt() {
    return this.aesDecrypt(this.val())
}; //$.fn.valAesEncryptSet = function (a) {
function valAesEncryptSet(a) {
    ...
    try {
        ...
        n == '' && (t = this.aesEncrypt(i))
        return t;

}
//联通密码校验(暂时放在这里)
function isSimplePwd(pwd) {
	  var userPwd = pwd.trim();
